...
public class MediaProcessorServiceTests_Simple {
    ...
    public MediaProcessorServiceTests_Simple() {
    ...
    public async Task ProcessAsync_WithInvalidResourceType_ReturnsFailure() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Undefined, input, "image/png", "test.png", _ct);
    ...
    public async Task ProcessAsync_WithInvalidContentType_ReturnsFailure() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Background, input, "application/pdf", "test.pdf", _ct);
    ...
    public async Task ProcessAsync_WithFileTooLarge_ReturnsFailure() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Background, input, "image/png", "test.png", _ct);
    ...
    public async Task ProcessAsync_WithValidImageUnderMaxSize_ProcessesSuccessfully() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Token, input, "image/png", "test.png", _ct);
    ...
    public async Task GenerateThumbnailAsync_WithValidImage_ReturnsThumbnail() {
        ...
        var thumbnail = await _service.GenerateThumbnailAsync(input, "image/png", 256, _ct);
    ...
    public async Task GenerateThumbnailAsync_WithAudioContent_ReturnsNull() {
        ...
        var thumbnail = await _service.GenerateThumbnailAsync(input, "audio/mpeg", 256, _ct);
    ...
    public async Task GenerateThumbnailAsync_WithUnsupportedContentType_ReturnsNull() {
        ...
        var thumbnail = await _service.GenerateThumbnailAsync(input, "application/pdf", 256, _ct);
    ...
    public async Task ProcessAsync_WithJpegImage_ConvertsToPng() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Token, input, "image/jpeg", "test.jpg", _ct);
    ...
    public async Task ProcessAsync_WithGifImage_ConvertsToPng() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Token, input, "image/gif", "test.gif", _ct);
    ...
    public async Task ProcessAsync_WithWebPImage_ConvertsToPng() {
        ...
        var result = await _service.ProcessAsync(ResourceType.Illustration, input, "image/webp", "test.webp", _ct);
    ...
    public async Task ProcessAsync_RespectsResourceTypeConstraints(ResourceType resourceType, int maxWidth, int maxHeight) {
        ...
        var result = await _service.ProcessAsync(resourceType, input, "image/png", "test.png", _ct);
