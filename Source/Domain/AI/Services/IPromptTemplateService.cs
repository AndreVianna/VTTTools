...
public interface IPromptTemplateService {
    ...
    Task<Result<PromptTemplate>> CreateAsync(CreatePromptTemplateData data, CancellationToken ct = default);

    Task<Result<PromptTemplate>> UpdateAsync(Guid id, UpdatePromptTemplateData data, CancellationToken ct = default);
