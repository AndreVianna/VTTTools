...
public class AdventurePageTests
    ...
    public AdventurePageTests() {
        Services.AddSingleton(_libraryServerHttpClient);
    ...
    public void AdventurePage_InViewMode_DisplaysCorrectButtons() {
        ...
        _libraryServerHttpClient.GetAdventureByIdAsync(guid).Returns(_testAdventure);
    ...
    public void AdventurePage_SaveButton_SubmitsForm() {
        // Arrange
        _libraryServerHttpClient.CreateAdventureAsync(Arg.Any<CreateAdventureRequest>())
        ...
        // Assert
        _libraryServerHttpClient.Received(1).CreateAdventureAsync(Arg.Is<CreateAdventureRequest>(request =>
