...
public class AdventurePageTests
    ...
    public AdventurePageTests() {
        Services.AddSingleton(_libraryClient);
    ...
    public void AdventurePage_InViewMode_DisplaysCorrectButtons() {
        ...
        _libraryClient.GetAdventureByIdAsync(guid).Returns(_testAdventure);
    ...
    public void AdventurePage_SaveButton_SubmitsForm() {
        // Arrange
        _libraryClient.CreateAdventureAsync(Arg.Any<CreateAdventureRequest>())
        ...
        // Assert
        _libraryClient.Received(1).CreateAdventureAsync(Arg.Is<CreateAdventureRequest>(request =>
