...
internal static class TokenHandler {
    public static async Task<IResult> GenerateTokenAsync(ITokenHandler handler, HttpContext context) {
...
internal sealed class TokenHandler<TDatabase>(TDatabase data,
                                IConfiguration configuration,
                                ICacheService cache,
                                ILogger<TokenHandler<TDatabase>> logger)
    : ITokenHandler
