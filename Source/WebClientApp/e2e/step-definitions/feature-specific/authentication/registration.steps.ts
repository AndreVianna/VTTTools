...
Given('an account already exists with email {string}', async function (this: CustomWorld, email: string) {
...
Given('an account already exists with name {string}', async function (this: CustomWorld, name: string) {
...
Given('I provide other valid registration data', async function (this: CustomWorld) {
  ...
  this.attach(
    `Form after "provide other valid data":\nEmail: "${emailValue}"\nName: "${nameValue}"\nPassword: "${passwordValue}"`,
    'text/plain',
  );
});

Given('I have entered invalid email {string}', async function (this: CustomWorld, email: string) {
...
Given('I successfully register with email {string}', async function (this: CustomWorld, _email: string) {
...
const enterEmailForRegistration = async function (this: CustomWorld, _email: string) {
  ...
  const emailValue = await emailInput.inputValue();
  this.attach(
    `Generated unique email for registration: ${uniqueEmail}\nEmail field value: "${emailValue}"`,
    'text/plain',
  );
};
...
Given('I enter matching confirmation password {string}', async function (this: CustomWorld, password: string) {
...
When('I enter valid display name {string}', async function (this: CustomWorld, displayName: string) {
...
Then('I receive a verification email at {string}', async function (this: CustomWorld, _email: string) {
...
Then('my account is marked as {string}', async function (this: CustomWorld, _status: string) {
