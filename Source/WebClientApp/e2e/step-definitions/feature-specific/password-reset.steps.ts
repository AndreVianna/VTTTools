...
Given('I am on the password reset request page', async function (this: CustomWorld) {
  ...
  const forgotPasswordLink = this.page.getByRole('button', {
...
Given('I navigate to password reset confirmation page with valid token', async function (this: CustomWorld) {
  const response = await this.page.request.get(
    `/api/auth/test/generate-reset-token?email=${encodeURIComponent(this.currentUser.email)}`,
  );
  expect(response.ok()).toBeTruthy();
  ...
  await this.page.goto(
    `/reset-password?email=${encodeURIComponent(this.currentUser.email)}&token=${encodeURIComponent(token)}&validated=true`,
  );
...
Given(
  'I have requested password reset {int} times in the {int} minutes',
  async function (this: CustomWorld, count: number, _minutes: number) {
...
Given('I received a password reset email', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify password reset email was received (ConsoleEmailService does not store emails - need email testing service or database table)',
  );
});
...
Given('I am on the password reset confirmation page', async function (this: CustomWorld) {
  ...
  await expect(this.page.locator('h1:has-text("Reset Password"), h2:has-text("Reset Password")')).toBeVisible({
    timeout: 10000,
  });
...
Given('the token has not been used', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token has not been used yet (query database PasswordResetTokens table and check Used=false)',
  );
});

Given('the reset token has already been used', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to mark token as used (ASP.NET Identity manages tokens internally - cannot manipulate via database)',
  );
});

Given('the reset link has email {string}', async function (this: CustomWorld, email: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify reset link contains email parameter "${email}" (ConsoleEmailService does not store emails - need email testing service)`,
  );
});
...
Given('my old password was {string}', async function (this: CustomWorld, oldPassword: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to store old password for comparison after reset (${oldPassword.length} chars)`,
  );
});
...
Given('the system enforces password history', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to enable password history enforcement (configure system setting or feature flag)',
  );
});

Given('my current password is {string}', async function (this: CustomWorld, currentPassword: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to store/verify current password for testing password history (${currentPassword.length} chars)`,
  );
});
...
When('I submit the reset request form', async function (this: CustomWorld) {
  const responsePromise = this.page.waitForResponse((response) => response.url().includes('/api/auth/password/forgot'));
...
When('the email service fails to send the email', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to mock email service failure (requires dependency injection mock or service fault injection)',
  );
});
...
When('the reset email is generated', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to wait for and verify email generation (ConsoleEmailService does not store emails - need email testing service or database table)',
  );
});

When('the reset link is generated', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify reset link was generated with valid token (ConsoleEmailService does not store emails - need email testing service)',
  );
});
...
When('I submit the password reset form', async function (this: CustomWorld) {
  const responsePromise = this.page.waitForResponse((response) => response.url().includes('/api/auth/password/reset'));
...
When('the update completes', async function (this: CustomWorld) {
  await this.page.waitForResponse(
    (response) => response.url().includes('/api/auth/confirm-reset') && response.status() === 200,
  );
});
...
Then('a reset email should be sent to {string}', async function (this: CustomWorld, email: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify email was sent to "${email}" (ConsoleEmailService does not store emails - need email testing service or SentEmails database table)`,
  );
});
...
Then('no email should actually be sent', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify no email was sent (ConsoleEmailService does not store emails - need email testing service or SentEmails database table)',
  );
});
...
Then('a reset token is generated', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token was generated (ASP.NET Identity manages tokens internally via Data Protection API - cannot verify via database)',
  );
});

Then(
  'my token be cryptographically secure with {int}+ bytes entropy',
  async function (this: CustomWorld, minBytes: number) {
    throw new Error(
      `NOT IMPLEMENTED: Step needs to verify token has ${minBytes}+ bytes entropy (ASP.NET Identity tokens use Data Protection API - cannot inspect token structure)`,
    );
  },
);
...
Then('my token have expiration timestamp {int} hours from now', async function (this: CustomWorld, hours: number) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify token expires in ${hours} hours (ASP.NET Identity manages expiration internally - cannot inspect token timestamp)`,
  );
});

Then('my token be URL-safe', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token uses URL-safe characters (ASP.NET Identity tokens use Data Protection API - cannot inspect token format)',
  );
});

Then('the previous token should be invalidated', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify previous token was invalidated (ASP.NET Identity manages tokens internally - cannot query token status via database)',
  );
});

Then('a new I receive an authentication token', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify new token was generated (ASP.NET Identity manages tokens internally - cannot verify via database)',
  );
});

Then('only the new token should be valid', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify only new token is valid (ASP.NET Identity manages token validity internally - cannot test without attempting password reset)',
  );
});
...
Then('a reset email should be sent', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify email was sent (ConsoleEmailService does not store emails - need email testing service or SentEmails database table)',
  );
});

Then('a secure reset I receive an authentication token', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify secure token was generated (ASP.NET Identity manages tokens internally - cannot verify via database)',
  );
});

Then('the token is saved with user association', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token is associated with user (ASP.NET Identity manages token-user association internally - cannot verify via database)',
  );
});
...
Then('my email contain reset link {string}', async function (this: CustomWorld, linkPattern: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify email contains reset link "${linkPattern}" (ConsoleEmailService does not store emails - need email testing service)`,
  );
});

Then('my email mention {int}-hour expiration', async function (this: CustomWorld, hours: number) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify email mentions ${hours}-hour expiration (ConsoleEmailService does not store emails - need email testing service)`,
  );
});
...
Then('the error is logged server-side', async function (this: CustomWorld) {
  ...
  const recentLogs = logs.filter((log) => new Date(log.Timestamp).getTime() > Date.now() - 60000);
...
Then('the failure should be tracked for monitoring', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify failure was tracked in monitoring system (check error logs, metrics, or telemetry)',
  );
});
...
Then('the email subject should be {string}', async function (this: CustomWorld, subject: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify email subject is "${subject}" (ConsoleEmailService does not store emails - need email testing service or SentEmails database table)`,
  );
});

Then(
  'my email include greeting with username or {string}',
  async function (this: CustomWorld, defaultGreeting: string) {
    throw new Error(
      `NOT IMPLEMENTED: Step needs to verify email includes greeting with username or "${defaultGreeting}" (ConsoleEmailService does not store emails - need email testing service)`,
    );
  },
);
...
Then('my email explain someone requested password reset', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify email explains password reset request (ConsoleEmailService does not store emails - need email testing service)',
  );
});

Then('my email include the reset link button', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify email includes reset link button (ConsoleEmailService does not store emails - need email testing service)',
  );
});

Then('my email include {string} message', async function (this: CustomWorld, message: string) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to verify email includes "${message}" message (ConsoleEmailService does not store emails - need email testing service)`,
  );
});

Then('my email include support contact information', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify email includes support contact information (ConsoleEmailService does not store emails - need email testing service)',
  );
});

Then('the link should use HTTPS protocol', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify reset link uses HTTPS (ConsoleEmailService does not store emails - need email testing service)',
  );
});

Then('the link should point to the correct domain', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify link points to correct domain (ConsoleEmailService does not store emails - need email testing service)',
  );
});

Then('my token be included as a query parameter', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token is in query parameter (ConsoleEmailService does not store emails - need email testing service)',
  );
});

Then('only one request should be processed', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify only one request was sent (check network requests via Playwright or count API calls)',
  );
});

Then('I receive response with in less than {int}ms', async function (this: CustomWorld, maxTime: number) {
  throw new Error(
    `NOT IMPLEMENTED: Step needs to measure response time and verify it's under ${maxTime}ms (use performance.now() or timing API)`,
  );
});

Then('my email be sent asynchronously', async function (this: CustomWorld) {
  throw new Error(
    "NOT IMPLEMENTED: Step needs to verify email sending doesn't block response (requires timing comparison between API response and email send event)",
  );
});
...
Then('my token be marked as used', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token was marked as used (ASP.NET Identity manages tokens internally - cannot query token usage status via database)',
  );
});
...
Then('the error appears below the confirmation field', async function (this: CustomWorld) {
  ...
  const errorText = await confirmField
    .locator('xpath=following-sibling::*[contains(@class, "error") or contains(@class, "helper")]')
    .textContent();
...
Then('the hash should be irreversible', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify hash is one-way (check hash format and ensure it cannot be reversed)',
  );
});
...
Then('all other reset tokens for my account should be invalidated', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify all other tokens were invalidated (ASP.NET Identity manages tokens internally - cannot query token status via database)',
  );
});

Then('they should not be usable', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify tokens are marked as unusable (check PasswordResetTokens table Invalidated/Used flags)',
  );
});
...
Then(
  'I should be able to click {string} to redirect immediately',
...
Then('my reset token should remain valid', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify token remains valid (ASP.NET Identity manages token validity internally - cannot verify without attempting to use token)',
  );
});

Then('I should be able to use the reset link again later', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify reset link/token remains valid for reuse (check token expiration and used status)',
  );
});
...
Then('only one update request should be sent', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify only one request was sent (monitor network requests via Playwright)',
  );
});

Then('the password hashing should use appropriate cost factor', async function (this: CustomWorld) {
  throw new Error(
    'NOT IMPLEMENTED: Step needs to verify password hashing cost factor is appropriate (check backend configuration or hash metadata)',
  );
});
