...
When(
  'I keep both {string} and {string} unchecked',
  async function (this: CustomWorld, checkbox1: string, checkbox2: string) {
...
Given(
  'both {string} and {string} checkboxes are checked',
  async function (this: CustomWorld, checkbox1: string, checkbox2: string) {
    await this.page.check(`input[name="${checkbox1}"]`);
    await this.page.check(`input[name="${checkbox2}"]`);
  },
...
Given(
  'both {string} and {string} checkboxes are unchecked',
  async function (this: CustomWorld, checkbox1: string, checkbox2: string) {
    await this.page.uncheck(`input[name="${checkbox1}"]`);
    await this.page.uncheck(`input[name="${checkbox2}"]`);
  },
