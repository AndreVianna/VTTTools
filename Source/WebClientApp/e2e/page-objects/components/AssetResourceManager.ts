...
import type { KeyboardModifierHelper } from '../../support/helpers/keyboard.helper.js';
...
export class AssetResourceManager extends BasePage {
  ...
  readonly portraitUploadButton = (): Locator =>
    this.page.locator('[data-testid="portrait-section"] button:has-text("Upload")');
  readonly portraitRemoveButton = (): Locator =>
    this.page.locator('[data-testid="portrait-section"] button:has-text("Remove")');

  constructor(page: Page, _keyboard: KeyboardModifierHelper) {
    super(page);
  }
