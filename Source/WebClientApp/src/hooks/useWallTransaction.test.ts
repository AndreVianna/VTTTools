    ...
    describe('pushLocalAction', () => {
        ...
        it('should increase undo stack length correctly with multiple actions', () => {
            ...
            const actions: LocalAction[] = [
                { type: 'ACTION_1', description: 'Action 1', undo: vi.fn(), redo: vi.fn() },
                { type: 'ACTION_2', description: 'Action 2', undo: vi.fn(), redo: vi.fn() },
                { type: 'ACTION_3', description: 'Action 3', undo: vi.fn(), redo: vi.fn() }
            ];
