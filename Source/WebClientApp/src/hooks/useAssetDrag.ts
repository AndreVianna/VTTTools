...
/**
 * useAssetDrag Hook
 * Manages drag-and-drop state for assets from the asset library to the scene canvas
 ...
 * Used to coordinate drag operations between asset library and scene canvas
 */
