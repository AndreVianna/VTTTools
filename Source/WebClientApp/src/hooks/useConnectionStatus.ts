...
export const useConnectionStatus = (options: UseConnectionStatusOptions = {}): ConnectionStatus => {
  const { healthEndpoint = DEFAULT_HEALTH_ENDPOINT, pollInterval = DEFAULT_POLL_INTERVAL, onStatusChange } = options;
