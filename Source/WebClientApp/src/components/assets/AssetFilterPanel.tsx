...
export const AssetFilterPanel: React.FC<AssetFilterPanelProps> = ({ filters, onFiltersChange }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {hasActiveFilters && (
          <Button size='small' startIcon={<ClearIcon />} onClick={handleResetFilters}>
            Reset
          </Button>
        )}
      </Box>
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          onFiltersChange({
                            ...filters,
                            showPublished: e.target.checked,
                          })
                        }
                      />
                    }
