...
export interface PlacementCursorProps {
  ...
  /** Ref to EncounterCanvasHandle for accessing stage in effects */
  canvasRef: React.RefObject<EncounterCanvasHandle | null>;
...
export const PlacementCursor: React.FC<PlacementCursorProps> = ({ asset, gridConfig, canvasRef, scale, stagePos }) => {
  const [rawMousePos, setRawMousePos] = useState<{
    x: number;
    y: number;
  } | null>(null);
