...
import type { Point, EncounterSource, EncounterWall } from '@/types/domain';
...
export const SourceDrawingTool: React.FC<SourceDrawingToolProps> = ({
    ...
    }, [centerPos, currentRange, currentDirection, currentSpread, encounterId, source, isDirectional, addSource, onComplete]);
