 ...
 * Material-UI form for configuring encounter grid settings
 ...
 */
export const GridConfigPanel: React.FC<GridConfigPanelProps> = ({ initialGrid, onSave, onCancel }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      // Call backend API: PATCH /api/library/encounters/{id}/grid
      await onSave(grid);
    } catch (_error) {
          ...
          <TextField
            ...
            onChange={(e) => {
              ...
              if (!Number.isNaN(value)) {
                setGrid((prev) => ({
                  ...prev,
                  cellSize: { ...prev.cellSize, width: value },
                }));
              }
            }}
          ...
          <TextField
            ...
            onChange={(e) => {
              ...
              if (!Number.isNaN(value)) {
                setGrid((prev) => ({
                  ...prev,
                  cellSize: { ...prev.cellSize, height: value },
                }));
              }
            }}
