      ...
      >
        {objects.length === 0 ? (
          <ListItem>
            <ListItemText
              primary={
                <Typography sx={{ fontSize: '10px', color: theme.palette.text.disabled }}>No objects placed</Typography>
              }
            />
          </ListItem>
        ) : (
              ...
              <React.Fragment key={placedAsset.id}>
                ...
                <Collapse in={isExpanded} timeout='auto' unmountOnExit>
                  ...
                  >
                    ...
                    >
                      Position: ({placedAsset.position?.x?.toFixed(0) ?? '0'}, {placedAsset.position?.y?.toFixed(0) ?? '0'})
                    </Typography>
