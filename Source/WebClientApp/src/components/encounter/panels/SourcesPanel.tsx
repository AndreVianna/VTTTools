      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, p: 1 }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <TextField label='Type' value={type} disabled size='small' sx={{ ...compactStyles.textField, flex: 1 }} />
            <input
              type='color'
              value={color}
          ...
          <FormControlLabel
            control={<Checkbox size='small' checked={hasGradient} onChange={(e) => setHasGradient(e.target.checked)} />}
          ...
          <FormControlLabel
            control={
              <Checkbox size='small' checked={isDirectional} onChange={(e) => setIsDirectional(e.target.checked)} />
            }
        ...
        {isDirectional && (
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
              <Typography sx={{ fontSize: '9px', color: theme.palette.text.secondary }}>Spread: {spread}°</Typography>
              <Slider
                value={spread}
        ...
        <Button variant='contained' fullWidth size='small' sx={compactStyles.button} onClick={handlePlaceSource}>
          Place Source
        </Button>

        <Typography variant='overline' sx={compactStyles.sectionHeader}>
          Placed Sources ({encounterSources.length})
        </Typography>
