                                        ...
                                        {isExpanded ? (
                                            <TextField
                                                ...
                                                onBlur={(e) => {
                                                    ...
                                                    if (trimmedValue.length > 0 && trimmedValue.length <= 64 && trimmedValue !== encounterRegion.name) {
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    handleRegionPropertyUpdate(encounterRegion.index, { color: newColor });
                                                }}
                                                onKeyDown={(e) => {
                                                    e.stopPropagation();
                                                }}
                                        ...
                                        {(editedTypes.get(encounterRegion.index) ?? encounterRegion.type) === 'Elevation' ? (
                                            ...
                                            <FormControl size="small" fullWidth onClick={(e) => e.stopPropagation()}>
                                                ...
                                                <Select
                                                    ...
                                                    sx={compactStyles.select}
                                                >
                                                    {(editedTypes.get(encounterRegion.index) ?? encounterRegion.type) === 'Terrain' && TERRAIN_VALUES.map(val => (
                                                        <MenuItem key={val} value={val} sx={{ fontSize: '11px', minHeight: '32px' }}>
                                                            {val}
                                                        </MenuItem>
                                                    ))}
                                                    {(editedTypes.get(encounterRegion.index) ?? encounterRegion.type) === 'Illumination' && ILLUMINATION_VALUES.map(val => (
                                                        <MenuItem key={val} value={val} sx={{ fontSize: '11px', minHeight: '32px' }}>
                                                            {val}
                                                        </MenuItem>
                                                    ))}
