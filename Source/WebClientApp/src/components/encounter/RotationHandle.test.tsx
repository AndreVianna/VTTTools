...
import type { PlacedAsset, Asset } from '@/types/domain';
import { AssetKind, DisplayName, LabelPosition } from '@/types/domain';
import { rotatePointAroundOrigin, calculateAngleFromCenter } from '@/utils/rotationUtils';
...
describe('RotationHandle Logic', () => {
    ...
    it('calculates group center for multiple assets', () => {
        const asset2 = { ...mockAsset, id: 'asset-2', position: { x: 200, y: 200 } };
