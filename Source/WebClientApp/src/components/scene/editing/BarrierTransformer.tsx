...
export interface BarrierTransformerProps {
    poles: Pole[];
...
export const BarrierTransformer: React.FC<BarrierTransformerProps> = ({
    poles,
    onPolesChange,
    gridConfig,
    snapEnabled = true
...
BarrierTransformer.displayName = 'BarrierTransformer';
