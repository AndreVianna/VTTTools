...
const mockSceneRegion: SceneRegion = {
    id: 'scene-region-1',
    sceneId: 'scene-1',
    regionId: 'region-1',
    vertices: [
...
describe('RegionRenderer label display', () => {
    it('should get label from labelMap when value exists', () => {
        const label = mockRegion.labelMap[mockSceneRegion.value];
...
describe('RegionRenderer props validation', () => {
    it('should have valid sceneRegion structure', () => {
        expect(mockSceneRegion.id).toBeTruthy();
        expect(mockSceneRegion.sceneId).toBeTruthy();
        expect(mockSceneRegion.regionId).toBeTruthy();
        expect(mockSceneRegion.vertices.length).toBeGreaterThanOrEqual(3);
        expect(typeof mockSceneRegion.value).toBe('number');
    });
    ...
    it('should have valid vertex coordinates', () => {
        mockSceneRegion.vertices.forEach(vertex => {
