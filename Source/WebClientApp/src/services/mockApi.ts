    ...
    const assets: Asset[] = [
      {
        ...
        tokens: [
          createMockMediaResource('hero-token'),
      ...
      },
      {
        ...
        size: { width: 1, height: 1 },
        tokens: [
          createMockMediaResource('goblin-token'),
      ...
      },
      {
        ...
        tokens: [
          createMockMediaResource('ogre-token'),
      ...
      },
      {
        ...
        tokens: [
          createMockMediaResource('dragon-token'),
      ...
      },
      {
        ...
        portrait: null,
        size: { width: 1, height: 1 },
        tokens: [createMockMediaResource('crate-token')],
        statBlocks: {},
        tags: [],
        ownerId: 'mock-owner',
        isPublished: true,
      ...
      },
      {
        ...
        size: { width: 1, height: 1 },
        tokens: [
          createMockMediaResource('chest-token'),
      ...
      },
      {
        ...
        portrait: null,
        size: { width: 1, height: 1 },
        tokens: [createMockMediaResource('wall-token')],
        statBlocks: {},
        tags: [],
        ownerId: 'mock-owner',
        isPublished: true,
      ...
      },
      {
        ...
        portrait: null,
        size: { width: 1, height: 1 },
        tokens: [createMockMediaResource('door-token')],
        statBlocks: {},
        tags: [],
        ownerId: 'mock-owner',
        isPublished: true,
      ...
      },
      {
        ...
        tokens: [createMockMediaResource('boulder-token')],
        statBlocks: {},
        tags: [],
        ownerId: 'mock-owner',
        isPublished: true,
