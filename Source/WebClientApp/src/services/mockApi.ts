    ...
    const characterAssets: CharacterAsset[] = [
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('hero-topdown'),
        portrait: createMockMediaResource('hero-portrait'),
        miniature: createMockMediaResource('hero-miniature'),
        photo: undefined,
      ...
      },
      {
        ...
        description: 'NPC with portrait but no topDown image (edge case)',
        isPublished: true,
        isPublic: false,
        topDown: undefined,
    ...
    const monsterAssets: MonsterAsset[] = [
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('goblin-topdown'),
        portrait: undefined,
        miniature: createMockMediaResource('goblin-miniature'),
        photo: undefined,
        size: { width: 1, height: 1, isSquare: true },
        tokenStyle: { shape: TokenShape.Circle },
      },
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('ogre-topdown'),
        portrait: createMockMediaResource('ogre-portrait'),
        miniature: createMockMediaResource('ogre-miniature'),
        photo: createMockMediaResource('ogre-photo'),
      ...
      },
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('dragon-topdown'),
        portrait: createMockMediaResource('dragon-portrait'),
        miniature: undefined,
        photo: createMockMediaResource('dragon-photo'),
    ...
    const objectAssets: ObjectAsset[] = [
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('crate-topdown'),
        portrait: undefined,
        miniature: undefined,
        photo: undefined,
        size: { width: 1, height: 1, isSquare: true },
      ...
      },
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('chest-topdown'),
        portrait: createMockMediaResource('chest-portrait'),
        miniature: createMockMediaResource('chest-miniature'),
        photo: undefined,
        size: { width: 1, height: 1, isSquare: true },
        isMovable: true,
        isOpaque: false,
      },
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('wall-topdown'),
        portrait: undefined,
        miniature: undefined,
        photo: undefined,
        size: { width: 1, height: 1, isSquare: true },
      ...
      },
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('door-topdown'),
        portrait: undefined,
        miniature: undefined,
        photo: undefined,
        size: { width: 1, height: 1, isSquare: true },
      ...
      },
      {
        ...
        isPublished: true,
        isPublic: true,
        topDown: createMockMediaResource('boulder-topdown'),
        portrait: undefined,
        miniature: undefined,
        photo: undefined,
      ...
      },
      {
        ...
        topDown: undefined,
        portrait: undefined,
        miniature: createMockMediaResource('fallback-miniature'),
        photo: createMockMediaResource('fallback-photo'),
        size: { width: 1, height: 1, isSquare: true },
        isMovable: true,
        isOpaque: false,
      },
