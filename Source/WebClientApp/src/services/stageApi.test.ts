    ...
    describe('endpoint URL configurations', () => {
        describe('Stage CRUD URL patterns', () => {
            it('getStages should query empty string (base URL)', async () => {
                await store.dispatch(stageApi.endpoints.getStages.initiate() as any);
                expect(capturedRequest?.url).toBe('');
            });

            it('getStageById should query /{id}', async () => {
                await store.dispatch(stageApi.endpoints.getStageById.initiate('stage-123') as any);
            ...
            it('createStage should POST to empty string with body', async () => {
                ...
                await store.dispatch(stageApi.endpoints.createStage.initiate(data) as any);
                expect(capturedRequest?.url).toBe('');
            ...
            it('updateStage should PATCH to /{id} with body', async () => {
                ...
                await store.dispatch(stageApi.endpoints.updateStage.initiate({ id: 'stage-123', data }) as any);
                expect(capturedRequest?.url).toBe('/stage-123');
            ...
            it('deleteStage should DELETE /{id}', async () => {
                await store.dispatch(stageApi.endpoints.deleteStage.initiate('stage-123') as any);
                expect(capturedRequest?.url).toBe('/stage-123');
                expect(capturedRequest?.method).toBe('DELETE');
            });

            it('cloneStage should POST to /{id}/clone', async () => {
                await store.dispatch(stageApi.endpoints.cloneStage.initiate('stage-123') as any);
        ...
        describe('Wall URL patterns', () => {
            it('addWall should POST to /{stageId}/walls', async () => {
                ...
                await store.dispatch(stageApi.endpoints.addWall.initiate({ stageId: 'stage-123', data }) as any);
            ...
            it('updateWall should PATCH to /{stageId}/walls/{index}', async () => {
                ...
                await store.dispatch(stageApi.endpoints.updateWall.initiate({ stageId: 'stage-123', index: 0, data }) as any);
            ...
            it('deleteWall should DELETE /{stageId}/walls/{index}', async () => {
                await store.dispatch(stageApi.endpoints.deleteWall.initiate({ stageId: 'stage-123', index: 2 }) as any);
        ...
        describe('Region URL patterns', () => {
            it('addRegion should POST to /{stageId}/regions', async () => {
                ...
                await store.dispatch(stageApi.endpoints.addRegion.initiate({ stageId: 'stage-123', data }) as any);
            ...
            it('updateRegion should PATCH to /{stageId}/regions/{index}', async () => {
                ...
                await store.dispatch(stageApi.endpoints.updateRegion.initiate({ stageId: 'stage-123', index: 1, data }) as any);
            ...
            it('deleteRegion should DELETE /{stageId}/regions/{index}', async () => {
                await store.dispatch(stageApi.endpoints.deleteRegion.initiate({ stageId: 'stage-123', index: 3 }) as any);
        ...
        describe('Light URL patterns', () => {
            it('addLight should POST to /{stageId}/lights', async () => {
                ...
                await store.dispatch(stageApi.endpoints.addLight.initiate({ stageId: 'stage-123', data }) as any);
            ...
            it('updateLight should PATCH to /{stageId}/lights/{index}', async () => {
                ...
                await store.dispatch(stageApi.endpoints.updateLight.initiate({ stageId: 'stage-123', index: 0, data }) as any);
            ...
            it('deleteLight should DELETE /{stageId}/lights/{index}', async () => {
                await store.dispatch(stageApi.endpoints.deleteLight.initiate({ stageId: 'stage-123', index: 4 }) as any);
        ...
        describe('Element URL patterns', () => {
            it('addElement should POST to /{stageId}/elements', async () => {
                ...
                await store.dispatch(stageApi.endpoints.addElement.initiate({ stageId: 'stage-123', data }) as any);
            ...
            it('updateElement should PATCH to /{stageId}/elements/{index}', async () => {
                ...
                await store.dispatch(stageApi.endpoints.updateElement.initiate({ stageId: 'stage-123', index: 2, data }) as any);
            ...
            it('deleteElement should DELETE /{stageId}/elements/{index}', async () => {
                await store.dispatch(stageApi.endpoints.deleteElement.initiate({ stageId: 'stage-123', index: 5 }) as any);
        ...
        describe('Sound URL patterns', () => {
            it('addSound should POST to /{stageId}/sounds', async () => {
                ...
                await store.dispatch(stageApi.endpoints.addSound.initiate({ stageId: 'stage-123', data }) as any);
            ...
            it('updateSound should PATCH to /{stageId}/sounds/{index}', async () => {
                ...
                await store.dispatch(stageApi.endpoints.updateSound.initiate({ stageId: 'stage-123', index: 1, data }) as any);
            ...
            it('deleteSound should DELETE /{stageId}/sounds/{index}', async () => {
                await store.dispatch(stageApi.endpoints.deleteSound.initiate({ stageId: 'stage-123', index: 6 }) as any);
