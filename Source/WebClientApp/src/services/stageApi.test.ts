...
// Helper to dispatch RTK Query actions with proper typing
 
const dispatchQuery = (store: EnhancedStore, action: any) => store.dispatch(action);
    ...
    describe('endpoint URL configurations', () => {
        describe('Stage CRUD URL patterns', () => {
            it('getStages should query empty string (base URL)', async () => {
                await dispatchQuery(store, stageApi.endpoints.getStages.initiate());
                expect(capturedRequest?.url).toBe('');
            });

            it('getStageById should query /{id}', async () => {
                await dispatchQuery(store, stageApi.endpoints.getStageById.initiate('stage-123'));
            ...
            it('createStage should POST to empty string with body', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.createStage.initiate(data));
                expect(capturedRequest?.url).toBe('');
            ...
            it('updateStage should PATCH to /{id} with body', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.updateStage.initiate({ id: 'stage-123', data }));
                expect(capturedRequest?.url).toBe('/stage-123');
            ...
            it('deleteStage should DELETE /{id}', async () => {
                await dispatchQuery(store, stageApi.endpoints.deleteStage.initiate('stage-123'));
                expect(capturedRequest?.url).toBe('/stage-123');
                expect(capturedRequest?.method).toBe('DELETE');
            });

            it('cloneStage should POST to /{id}/clone', async () => {
                await dispatchQuery(store, stageApi.endpoints.cloneStage.initiate('stage-123'));
        ...
        describe('Wall URL patterns', () => {
            it('addWall should POST to /{stageId}/walls', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.addWall.initiate({ stageId: 'stage-123', data }));
            ...
            it('updateWall should PATCH to /{stageId}/walls/{index}', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.updateWall.initiate({ stageId: 'stage-123', index: 0, data }));
            ...
            it('deleteWall should DELETE /{stageId}/walls/{index}', async () => {
                await dispatchQuery(store, stageApi.endpoints.deleteWall.initiate({ stageId: 'stage-123', index: 2 }));
        ...
        describe('Region URL patterns', () => {
            it('addRegion should POST to /{stageId}/regions', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.addRegion.initiate({ stageId: 'stage-123', data }));
            ...
            it('updateRegion should PATCH to /{stageId}/regions/{index}', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.updateRegion.initiate({ stageId: 'stage-123', index: 1, data }));
            ...
            it('deleteRegion should DELETE /{stageId}/regions/{index}', async () => {
                await dispatchQuery(store, stageApi.endpoints.deleteRegion.initiate({ stageId: 'stage-123', index: 3 }));
        ...
        describe('Light URL patterns', () => {
            it('addLight should POST to /{stageId}/lights', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.addLight.initiate({ stageId: 'stage-123', data }));
            ...
            it('updateLight should PATCH to /{stageId}/lights/{index}', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.updateLight.initiate({ stageId: 'stage-123', index: 0, data }));
            ...
            it('deleteLight should DELETE /{stageId}/lights/{index}', async () => {
                await dispatchQuery(store, stageApi.endpoints.deleteLight.initiate({ stageId: 'stage-123', index: 4 }));
        ...
        describe('Element URL patterns', () => {
            it('addElement should POST to /{stageId}/elements', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.addElement.initiate({ stageId: 'stage-123', data }));
            ...
            it('updateElement should PATCH to /{stageId}/elements/{index}', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.updateElement.initiate({ stageId: 'stage-123', index: 2, data }));
            ...
            it('deleteElement should DELETE /{stageId}/elements/{index}', async () => {
                await dispatchQuery(store, stageApi.endpoints.deleteElement.initiate({ stageId: 'stage-123', index: 5 }));
        ...
        describe('Sound URL patterns', () => {
            it('addSound should POST to /{stageId}/sounds', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.addSound.initiate({ stageId: 'stage-123', data }));
            ...
            it('updateSound should PATCH to /{stageId}/sounds/{index}', async () => {
                ...
                await dispatchQuery(store, stageApi.endpoints.updateSound.initiate({ stageId: 'stage-123', index: 1, data }));
            ...
            it('deleteSound should DELETE /{stageId}/sounds/{index}', async () => {
                await dispatchQuery(store, stageApi.endpoints.deleteSound.initiate({ stageId: 'stage-123', index: 6 }));
