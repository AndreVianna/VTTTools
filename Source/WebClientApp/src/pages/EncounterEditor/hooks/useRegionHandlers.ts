...
import type { Encounter, EncounterRegion, Point, PlacedRegion } from '@/types/domain';
...
import { updateRegionOptimistic, removeRegionOptimistic, syncRegionIndices, filterEncounterForMergeDetection } from '@/utils/encounterStateUtils';
...
export const useRegionHandlers = ({
    ...
    }, [encounterId, encounter, removeEncounterRegion, refetch, setEncounter, setPlacedRegions, selectedRegionIndex, setSelectedRegionIndex]);
    ...
    }, [encounter, editingRegionIndex, originalRegionVertices, regionTransaction, setEncounter, setEditingRegionIndex, setSelectedRegionIndex, setIsEditingRegionVertices, setOriginalRegionVertices]);
    ...
    }, [encounterId, encounter, drawingMode, drawingRegionIndex, regionTransaction, gridConfig, addEncounterRegion, updateEncounterRegion, removeEncounterRegion, setEncounter, setDrawingRegionIndex, setDrawingMode, setErrorMessage, executeMerge, recordAction, refetch]);
    ...
    }, [encounter, setEditingRegionIndex, setIsEditingRegionVertices, setOriginalRegionVertices, setDrawingMode, setDrawingRegionIndex, setSelectedRegionIndex, regionTransaction, setEncounter]);
    ...
    }, [encounter, setDrawingMode, setDrawingRegionIndex, setOriginalRegionVertices, setEditingRegionIndex, setIsEditingRegionVertices, setSelectedRegionIndex, regionTransaction]);
