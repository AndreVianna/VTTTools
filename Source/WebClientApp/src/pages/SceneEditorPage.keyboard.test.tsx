...
describe('SceneEditorPage - Keyboard Routing', () => {
    ...
    // Note: This duplicates SceneEditorPage keyboard handler for isolated testing
    // Consider refactoring to test actual SceneEditorPage integration
