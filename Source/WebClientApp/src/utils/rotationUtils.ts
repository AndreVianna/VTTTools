...
export const calculateAngleFromCenter = (center: Point, mouse: Point): number => {
...
export const rotatePointAroundOrigin = (point: Point, origin: Point, angleDegrees: number): Point => {
