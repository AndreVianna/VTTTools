...
import { hydratePlacedAssets, dehydratePlacedAssets } from './encounterMappers';
import type { EncounterAsset, Asset, PlacedAsset } from '@/types/domain';
...
describe('hydratePlacedAssets', () => {
    describe('name hydration', () => {
        ...
        it('falls back to asset name when encounterAsset name is null', async () => {
            const encounterAssetWithNullName = createMockEncounterAsset({ name: null as any });
        ...
        it('falls back to asset name when encounterAsset name is empty string', async () => {
            const encounterAssetWithEmptyName = createMockEncounterAsset({ name: '' });
