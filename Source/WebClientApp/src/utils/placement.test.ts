...
import { GridType, type GridConfig } from './gridCalculator';
...
describe('validatePlacement', () => {
    ...
    it('detects overlap when not allowed', () => {
        ...
        const existingAssets = [
            { x: 120, y: 120, width: 50, height: 50, allowOverlap: false },
        ];
    ...
    it('ignores overlap with assets that allow overlap', () => {
        ...
        const size = { width: 50, height: 50 };
        const existingAssets = [
            { x: 120, y: 120, width: 50, height: 50, allowOverlap: true },
        ];
    ...
    it('returns all validation errors when multiple constraints violated', () => {
        ...
        const existingAssets = [
            { x: 100, y: 100, width: 50, height: 50, allowOverlap: false },
        ];
