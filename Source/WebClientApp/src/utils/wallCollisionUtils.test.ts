...
describe('calculatePerpendicularDistance', () => {
  ...
  it('should handle zero-length line segment', () => {
    ...
    expect(calculatePerpendicularDistance(point, lineStart, lineEnd)).toBeCloseTo(Math.sqrt(50), 5);
  });
...
describe('detectPoleOnPoleCollision', () => {
  ...
  it('should detect no collision when poles are far apart', () => {
    ...
    const existingWalls = [createWall([createPole(100, 100), createPole(110, 100)], 0)];
  ...
  it('should detect multiple pole collisions', () => {
    ...
    const existingWalls = [createWall([createPole(1, 1), createPole(11, 1), createPole(100, 100)], 0)];
...
describe('detectEdgeOnEdgeIntersection', () => {
  ...
  it('should detect multiple intersections', () => {
    ...
    const existingWalls = [createWall([createPole(0, 10), createPole(10, 0), createPole(20, 0)], 0)];
