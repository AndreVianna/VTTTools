...
export function EncounterListView() {
    ...
    return (
        <Box id="encounter-list-container">
            <Box id="encounter-list-header" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
            ...
            {isLoading && (
                <Typography id="message-encounter-list-loading" variant="body1" color="text.secondary" sx={{ textAlign: 'center', py: 8 }}>
                    Loading encounters...
                </Typography>
            )}
            ...
            <Dialog
                ...
                aria-labelledby="dialog-title-delete-encounter"
            >
                <DialogTitle id="dialog-title-delete-encounter">
                    Delete Encounter
                </DialogTitle>
                <DialogContent>
                    <DialogContentText>
