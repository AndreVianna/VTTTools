...
export function CampaignListView() {
    ...
    return (
        <Box id="campaign-list-container">
            <Box id="campaign-list-header" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
            ...
            {isLoading && (
                <Typography id="message-campaign-list-loading" variant="body1" color="text.secondary" sx={{ textAlign: 'center', py: 8 }}>
                    Loading campaigns...
                </Typography>
            )}
            ...
            <Dialog
                ...
                aria-labelledby="dialog-title-delete-campaign"
            >
                <DialogTitle id="dialog-title-delete-campaign">
                    Delete Campaign
                </DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        Are you sure you want to delete this campaign? This will also delete all adventures within it. This action cannot be undone.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
