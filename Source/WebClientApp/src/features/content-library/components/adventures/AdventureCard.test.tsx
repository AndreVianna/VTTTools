...
describe('AdventureCard', () => {
    const mockAdventure: AdventureCardType = {
        id: 'adventure-1',
    ...
    describe('rendering', () => {
        ...
        it('should show One-Shot badge when adventure.isOneShot is true', () => {
            // Arrange
            const oneShotAdventure: AdventureCardType = {
                ...mockAdventure,
                isOneShot: true,
            };
        ...
        it('should not show One-Shot badge when adventure.isOneShot is false', () => {
            // Arrange
            const regularAdventure: AdventureCardType = {
                ...mockAdventure,
                isOneShot: false,
            };
        ...
        it('should show adventure style badge with correct label for DungeonCrawl', () => {
            // Arrange
            const dungeonCrawlAdventure: AdventureCardType = {
                ...mockAdventure,
                style: AdventureStyle.DungeonCrawl,
            };
        ...
        it('should show adventure style badge with correct label for OpenWorld', () => {
            // Arrange
            const openWorldAdventure: AdventureCardType = {
                ...mockAdventure,
        ...
        it('should show adventure style badge with correct label for HackNSlash', () => {
            // Arrange
            const hackNSlashAdventure: AdventureCardType = {
                ...mockAdventure,
        ...
        it('should show Published badge when adventure.isPublished is true', () => {
            // Arrange
            const publishedAdventure: AdventureCardType = {
                ...mockAdventure,
                isPublished: true,
            };
        ...
        it('should not show Published badge when adventure.isPublished is false', () => {
            // Arrange
            const unpublishedAdventure: AdventureCardType = {
                ...mockAdventure,
                isPublished: false,
            };
        ...
        it('should show correct encounter count in metadata', () => {
            // Arrange
            const adventureWith5Encounters: AdventureCardType = {
                ...mockAdventure,
                encounterCount: 5,
            };
        ...
        it('should show singular encounter when count is 1', () => {
            // Arrange
            const adventureWith1Encounter: AdventureCardType = {
                ...mockAdventure,
                encounterCount: 1,
            };
        ...
        it('should show 0 encounters when encounterCount is 0', () => {
            // Arrange
            const adventureWithNoEncounters: AdventureCardType = {
                ...mockAdventure,
                encounterCount: 0,
            };
    ...
    describe('adventure style labels', () => {
        it('should show Generic label for Generic style', () => {
            // Arrange
            const adventure: AdventureCardType = { ...mockAdventure, style: AdventureStyle.Generic };
        ...
        it('should show Survival label for Survival style', () => {
            // Arrange
            const adventure: AdventureCardType = { ...mockAdventure, style: AdventureStyle.Survival };
        ...
        it('should show Goal Driven label for GoalDriven style', () => {
            // Arrange
            const adventure: AdventureCardType = { ...mockAdventure, style: AdventureStyle.GoalDriven };
        ...
        it('should show Randomly Generated label for RandomlyGenerated style', () => {
            // Arrange
            const adventure: AdventureCardType = { ...mockAdventure, style: AdventureStyle.RandomlyGenerated };
        ...
        it('should show Generic badge when style is Generic', () => {
            // Arrange
            const adventure: AdventureCardType = { ...mockAdventure, style: AdventureStyle.Generic };
