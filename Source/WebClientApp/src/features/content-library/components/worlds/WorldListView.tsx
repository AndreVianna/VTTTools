    ...
    <Box id='world-list-container'>
      ...
      {!isLoading && filteredWorlds.length === 0 && searchInput === '' && (
        <Box id='world-list-empty-state' sx={{ textAlign: 'center', py: 8 }}>
          ...
          <Button variant='contained' startIcon={<AddIcon />} onClick={handleCreateWorld}>
            Create World
          </Button>
        </Box>
      )}
      ...
      <Dialog open={deleteDialogOpen} onClose={cancelDelete} aria-labelledby='dialog-title-delete-world'>
        <DialogTitle id='dialog-title-delete-world'>Delete World</DialogTitle>
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete this world? This will also delete all campaigns and adventures within it.
