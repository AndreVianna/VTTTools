...
describe('twoFactorApi', () => {
    ...
    describe('initiateSetup endpoint', () => {
        ...
        it('should call POST /two-factor/setup', async () => {
            ...
            // Act
            await store.dispatch(twoFactorApi.endpoints.initiateSetup.initiate() as unknown as UnknownAction);
    ...
    describe('verifySetup endpoint', () => {
        ...
        it('should call PUT /two-factor/setup with body', async () => {
            ...
            // Act
            await store.dispatch(twoFactorApi.endpoints.verifySetup.initiate(verifyData) as unknown as UnknownAction);
    ...
    describe('disableTwoFactor endpoint', () => {
        ...
        it('should call DELETE /two-factor with body', async () => {
            ...
            // Act
            await store.dispatch(twoFactorApi.endpoints.disableTwoFactor.initiate(disableData) as unknown as UnknownAction);
