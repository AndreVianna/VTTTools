...
namespace VttTools.Data.Migrations
{
    ...
    [Migration("20250524152010_CreateApplicationSchema")]
            ...
            modelBuilder.Entity("VttTools.Data.Assets.Entities.Asset", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Shape", "VttTools.Data.Assets.Entities.Asset.Shape#Shape", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("Size", "VttTools.Data.Assets.Entities.Asset.Shape#Shape.Size#Vector2", b2 =>
                                {
                                    b2.Property<float>("X")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("real")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Stage", "VttTools.Data.Library.Entities.Scene.Stage#Stage", b1 =>
                        {
                            ...
                            b1.Property<float>("ZoomLevel")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("real")
                                .HasDefaultValue(1f);

                            b1.ComplexProperty<Dictionary<string, object>>("Grid", "VttTools.Data.Library.Entities.Scene.Stage#Stage.Grid#Grid", b2 =>
                                {
                                    b2.IsRequired();
                                    ...
                                    b2.ComplexProperty<Dictionary<string, object>>("Cell", "VttTools.Data.Library.Entities.Scene.Stage#Stage.Grid#Grid.Cell#Cell", b3 =>
                                        {
                                            b3.IsRequired();

                                            b3.Property<float>("Size")
                                                .ValueGeneratedOnAdd()
                                                .HasColumnType("real")
                                                .HasDefaultValue(1f);

                                            b3.ComplexProperty<Dictionary<string, object>>("Offset", "VttTools.Data.Library.Entities.Scene.Stage#Stage.Grid#Grid.Cell#Cell.Offset#Vector2", b4 =>
                                                {
                                                    b4.Property<float>("X")
                                                        .ValueGeneratedOnAdd()
                                                        .HasColumnType("real")
                                            ...
                                            b3.ComplexProperty<Dictionary<string, object>>("Scale", "VttTools.Data.Library.Entities.Scene.Stage#Stage.Grid#Grid.Cell#Cell.Scale#Vector2", b4 =>
                                                {
                                                    b4.Property<float>("X")
                                                        .ValueGeneratedOnAdd()
                                                        .HasColumnType("real")
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("Shape", "VttTools.Data.Library.Entities.Scene.Stage#Stage.Shape#Shape", b2 =>
                                {
                                    b2.IsRequired();
                                    ...
                                    b2.ComplexProperty<Dictionary<string, object>>("Size", "VttTools.Data.Library.Entities.Scene.Stage#Stage.Shape#Shape.Size#Vector2", b3 =>
                                        {
                                            b3.Property<float>("X")
                                                .ValueGeneratedOnAdd()
                                                .HasColumnType("real")
            ...
            modelBuilder.Entity("VttTools.Data.Library.Entities.SceneAsset", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Position", "VttTools.Data.Library.Entities.SceneAsset.Position#Vector2", b1 =>
                        {
                            b1.Property<float>("X")
                                .HasColumnType("real");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Scale", "VttTools.Data.Library.Entities.SceneAsset.Scale#Vector2", b1 =>
                        {
                            b1.Property<float>("X")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("real")
