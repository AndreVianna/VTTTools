...
internal partial class ApplicationDbContextModelSnapshot : ModelSnapshot {
    protected override void BuildModel(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity("VttTools.Model.Assets.Asset", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
        ...
        modelBuilder.Entity("VttTools.Model.Game.GameSession", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Library.Adventure", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Library.Campaign", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Library.Epic", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Library.Scene", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Library.SceneAsset", b => {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Assets.Asset", b => {
            b.OwnsOne("VttTools.Model.Size", "Size", b1 => {
        ...
        modelBuilder.Entity("VttTools.Model.Game.GameSession", b => {
            b.OwnsMany("VttTools.Model.Game.GameSessionEvent", "Events", b1 => {
            ...
            b.OwnsMany("VttTools.Model.Game.GameSessionMessage", "Messages", b1 => {
                b1.Property<Guid>("GameSessionId")
                    .HasColumnType("uniqueidentifier");
            ...
            b.OwnsMany("VttTools.Model.Game.Player", "Players", b1 => {
                b1.Property<Guid>("GameSessionId")
                    .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Identity.RoleClaim", b => b.HasOne("VttTools.Model.Identity.Role", null)
                    .WithMany()
                    .HasForeignKey("RoleId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired());

        modelBuilder.Entity("VttTools.Model.Identity.UserClaim", b => b.HasOne("VttTools.Model.Identity.User", null)
                    .WithMany()
                    .HasForeignKey("UserId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired());

        modelBuilder.Entity("VttTools.Model.Identity.UserLogin", b => b.HasOne("VttTools.Model.Identity.User", null)
                    .WithMany()
                    .HasForeignKey("UserId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired());
        ...
        modelBuilder.Entity("VttTools.Model.Identity.UserToken", b => b.HasOne("VttTools.Model.Identity.User", null)
                    .WithMany()
                    .HasForeignKey("UserId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired());
        ...
        modelBuilder.Entity("VttTools.Model.Library.Adventure", b => {
            b.HasOne("VttTools.Model.Library.Campaign", "Campaign")
                .WithMany("Adventures")
        ...
        modelBuilder.Entity("VttTools.Model.Library.Campaign", b => {
            b.HasOne("VttTools.Model.Library.Epic", "Epic")
                .WithMany("Campaigns")
                .HasForeignKey("ParentId")
                .OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity("VttTools.Model.Library.Scene", b => {
            b.HasOne("VttTools.Model.Library.Adventure", "Adventure")
                .WithMany("Scenes")
                .HasForeignKey("ParentId")
                .OnDelete(DeleteBehavior.Cascade)
                .IsRequired();

            b.OwnsOne("VttTools.Model.Stage", "Stage", b1 => {
                ...
                b1.OwnsOne("VttTools.Model.Grid", "Grid", b2 => {
                    ...
                    b2.OwnsOne("VttTools.Model.Size", "CellSize", b3 => {
                    ...
                    b2.OwnsOne("VttTools.Model.Position", "Offset", b3 => {
                        b3.Property<Guid>("GridStageSceneId")
                            .HasColumnType("uniqueidentifier");
                ...
                b1.OwnsOne("VttTools.Model.Size", "Size", b2 => {
                    b2.Property<Guid>("StageSceneId")
                        .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("VttTools.Model.Library.SceneAsset", b => {
            b.HasOne("VttTools.Model.Assets.Asset", "Asset")
                .WithMany()
                .HasForeignKey("SceneId")
                .OnDelete(DeleteBehavior.Cascade)
                .IsRequired();

            b.HasOne("VttTools.Model.Library.Scene", "Scene")
                .WithMany("SceneAssets")
                .HasForeignKey("SceneId")
                .OnDelete(DeleteBehavior.Cascade)
                .IsRequired();

            b.OwnsOne("VttTools.Model.Position", "Position", b1 => {
        ...
        modelBuilder.Entity("VttTools.Model.Library.Adventure", b => b.Navigation("Scenes"));

        modelBuilder.Entity("VttTools.Model.Library.Campaign", b => b.Navigation("Adventures"));

        modelBuilder.Entity("VttTools.Model.Library.Epic", b => b.Navigation("Campaigns"));

        modelBuilder.Entity("VttTools.Model.Library.Scene", b => b.Navigation("SceneAssets"));
    }
}
