    ...
    protected override void Up(MigrationBuilder migrationBuilder) {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new {
                ...
                TwoFactorType = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "None")
            },
            constraints: table => {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new {
                ...
                PreferredName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
            },
            constraints: table => {
