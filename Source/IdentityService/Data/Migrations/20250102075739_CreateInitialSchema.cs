        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiClientClaims_ApiClients_ApiClientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roles_ApiClients_ApiClientId",
                        column: x => x.ApiClientId,
                        principalTable: "ApiClients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityStamp = table.Column<string>(type: "nvarchar(48)", maxLength: 48, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(48)", maxLength: 48, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiClientClaims_ApiClientId",
