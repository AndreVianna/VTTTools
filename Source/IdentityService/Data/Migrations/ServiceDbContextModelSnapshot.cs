...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HttpServices.Abstractions.Model.ApiConsumer", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(24)
            ...
            modelBuilder.Entity("HttpServices.Abstractions.Model.ApiConsumerToken", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(24)
                    ...
                    b.Property<string>("ApiConsumerId")
                        .HasColumnType("nvarchar(24)");
            ...
            modelBuilder.Entity("HttpServices.Abstractions.Model.UserIdentity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(24)
            ...
            modelBuilder.Entity("Domain.Model.UserProfile", b =>
                {
                    b.HasOne("HttpServices.Abstractions.Model.UserIdentity", null)
                        .WithOne()
                        .HasForeignKey("Domain.Model.UserProfile", "Id")
            ...
            modelBuilder.Entity("HttpServices.Abstractions.Model.ApiConsumerToken", b =>
                {
                    b.HasOne("HttpServices.Abstractions.Model.ApiConsumer", null)
                        .WithMany()
