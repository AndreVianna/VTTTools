...
import type { World, Campaign } from '../../../types/domain';
...
export interface WorldDetailPageProps {
  ...
  mediaBaseUrl: string;
  onBack: () => void;
  onUpdateWorld: (request: { name?: string; description?: string; isPublished?: boolean; backgroundId?: string }) => Promise<void>;
  onUploadFile: (file: File, type: string, resource: string, entityId: string) => Promise<{ id: string }>;
  onCreateCampaign: (request: { name: string; description: string }) => Promise<{ id: string }>;
