...
public static class EntityDefinitionFixtures {
    ...
    public static Asset CreateOrc() => new() {
        Name = "Orc",
        Classification = new(AssetKind.Creature, "Humanoid", "Orc", "Common"),
    ...
    public static Asset CreateDragonWithComplexVariants() => new() {
        Name = "Red Dragon",
        Classification = new(AssetKind.Creature, "Dragon", "Chromatic", "Red"),
    ...
    public static Asset CreateChest() => new() {
        Name = "Treasure Chest",
        Classification = new(AssetKind.Object, "Container", "Chest", "Wooden"),
    ...
    public static Asset CreateLargeVariantSet() => new() {
        Name = "TestEntity",
        Classification = new(AssetKind.Creature, "Test", "Test", "Test"),
