...
internal static class ApiDbContextBuilder {
    public static void CreateModel<TKey, TClient, TToken>(DbContext context, ModelBuilder modelBuilder)
        ...
        modelBuilder.Entity<TClient>(b => {
            ...
            b.HasMany<TToken>().WithOne().HasForeignKey(e => e.ClientId).IsRequired(false).OnDelete(DeleteBehavior.Cascade);
        });
...
internal static class IdentityProviderApiDbContextBuilder {
    public static void CreateModel<TKey, TClient, TToken, TUser, TUserClaim, TUserLogin, TUserToken, TRole, TUserRole, TRoleClaim>(DbContext context, ModelBuilder modelBuilder)
        where TKey : IEquatable<TKey>
        where TClient : ApiClient<TKey>
        where TToken : ApiToken<TKey>
        ...
        ApiDbContextBuilder.CreateModel<TKey, TClient, TToken>(context, modelBuilder);
        ...
        modelBuilder.Entity<TClient>(b => {
            ...
            b.HasMany<TUser>().WithOne().HasForeignKey(e => e.ClientId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
        });
