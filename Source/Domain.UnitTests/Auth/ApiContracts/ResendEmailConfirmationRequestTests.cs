...
public class ResendEmailConfirmationRequestTests {
    [Fact]
    ...
    public void WithClause_WithChangedValues_UpdatesProperties() {
        // Arrange
        var original = new ResendEmailConfirmationRequest {
    ...
    public void RecordEquality_WithSameValues_ReturnsTrue() {
        // Arrange
        var request1 = new ResendEmailConfirmationRequest {
            Email = "test@example.com",
        };
        var request2 = new ResendEmailConfirmationRequest {
            Email = "test@example.com",
        };
