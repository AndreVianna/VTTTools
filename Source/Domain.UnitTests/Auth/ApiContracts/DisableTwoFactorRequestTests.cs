...
public class DisableTwoFactorRequestTests {
    [Fact]
    ...
    public void WithClause_WithChangedValues_UpdatesProperties() {
        // Arrange
        var original = new DisableTwoFactorRequest {
    ...
    public void RecordEquality_WithSameValues_ReturnsTrue() {
        // Arrange
        var request1 = new DisableTwoFactorRequest {
            Password = "password123",
        };
        var request2 = new DisableTwoFactorRequest {
            Password = "password123",
        };
