    ...
    protected override void Up(MigrationBuilder migrationBuilder) {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => {
                ...
                table.ForeignKey(
                    name: "FK_Epics_Resources_BackgroundId",
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new {
                ...
                Light = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Ambient"),
            ...
            constraints: table => {
                ...
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_Encounters_Resources_SoundId",
                    column: x => x.SoundId,
                    principalTable: "Resources",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => {
                ...
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_EncounterAssets_Resources_PortraitId",
                    column: x => x.PortraitId,
                    principalTable: "Resources",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_EncounterAssets_Resources_TokenId",
                    column: x => x.TokenId,
                    principalTable: "Resources",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => {
                ...
                table.ForeignKey(
                    name: "FK_EncounterSources_Encounters_EncounterId",
                    column: x => x.EncounterId,
                    principalTable: "Encounters",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_EncounterAssets_PortraitId",
            table: "EncounterAssets",
            column: "PortraitId");

        migrationBuilder.CreateIndex(
            name: "IX_EncounterAssets_TokenId",
            table: "EncounterAssets",
            column: "TokenId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_Encounters_SoundId",
            table: "Encounters",
            column: "SoundId");

        migrationBuilder.CreateIndex(
            name: "IX_EncounterSources_EncounterId",
            table: "EncounterSources",
            column: "EncounterId");
