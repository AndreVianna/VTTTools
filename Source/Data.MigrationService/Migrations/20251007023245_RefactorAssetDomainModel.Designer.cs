...
namespace VttTools.Data.MigrationService.Migrations
{
    ...
    [Migration("20251007023245_RefactorAssetDomainModel")]
    partial class RefactorAssetDomainModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VttTools.Data.Assets.Entities.EntityAsset", b =>
                {
            ...
            modelBuilder.Entity("VttTools.Data.Assets.Entities.EntityAsset", b =>
                {
                    b.OwnsOne("VttTools.Data.Assets.Entities.EntityProperties", "Properties", b1 =>
                        {
                            b1.Property<Guid>("EntityAssetId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("EntityAssetId");

                            b1.ToTable("Assets");

                            b1.ToJson("EntityProperties");

                            b1.WithOwner()
                                .HasForeignKey("EntityAssetId");

                            b1.OwnsOne("VttTools.Data.Assets.Entities.TokenStyle", "TokenStyle", b2 =>
                                {
                                    b2.Property<Guid>("EntityPropertiesEntityAssetId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("EntityPropertiesEntityAssetId");

                                    b2.ToTable("Assets");

                                    b2.WithOwner()
                                        .HasForeignKey("EntityPropertiesEntityAssetId");
                                });
