        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preset = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Circle"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainBackgroundId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AlternateBackgroundId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    AmbientSoundLoop = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    AmbientSoundIsPlaying = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ...
                    GridCellHeight = table.Column<double>(type: "float", nullable: false, defaultValue: 50.0),
                    GridCellWidth = table.Column<double>(type: "float", nullable: false, defaultValue: 50.0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumns: new[] { "StageId", "Index" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rotation = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    Elevation = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    DisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EnabledDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DisabledDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OnTriggerDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TriggeredDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    State = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Enabled"),
                    IsHidden = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    TriggerShapeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    X = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    Y = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Elevation = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    DisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ClosedDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OpenedDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DestroyedDisplayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    State = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Closed"),
                    IsHidden = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsLocked = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    X = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    Y = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "AvatarId", "UnitSystem" },
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Assets",
                columns: new[] { "IsPublic", "IsPublished" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Assets",
                columns: new[] { "Kind", "Category", "Type" });
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "AssetId", "GameSystemId" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MaintenanceMode",
                columns: new[] { "IsEnabled", "ScheduledStartTime" });
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "StageId", "RegionIndex", "Index" });
