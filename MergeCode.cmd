...
:: Configuration
:: ------------------------------------------------------------------
set "ExcludedDirs=.git .vs .cursor .github .vscode Migrations obj bin pkg lib node_modules Properties TestResults uploads"
set "AllowedExts=.md .slnx .sln .csproj .cs .razor .json"
...
if "%RelativePath%"=="" set "RelativePath=Source"
